...
const createInnerHtml = () => {
    ...
    <td>
        <img id="${addressBook._id}" onclick="remove(this)" alt="delete" src="7.jpeg" width="30px">
        <a href="AddPage.html" onclick="update(this)"><img id="${addressBook._id}" onclick="update(this)" alt="edit" src="8.jpg" width="30px"></a>
    </td>
</tr>
`;
    }
